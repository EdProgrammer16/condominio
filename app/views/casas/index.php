                    ...
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            <div>
                                ...
                                <p class="text-sm mb-0">Exibindo todas as casas do Condominio.</p>
                            </div>
                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                <div class="ms-auto my-auto">
                                    <button type="button" class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#addCasa">
                                        +&nbsp; Nova Casa
                                    </button>
