                    ...
                    <div class="card-header pb-0">
                        <div class="d-lg-flex">
                            <div>
                                ...
                                <p class="text-sm mb-0">Exibindo todos os tecnicos do Condominio.</p>
                            </div>
                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                <div class="ms-auto my-auto">
                                    <a href="<?= DOC_PAGE; ?>tecnicos/add" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; Novo Tecnico</a>
                            ...
                            <table class="table table-flush" id="products-list">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        // }
                                    ?>
                                    <?php foreach($tecnicos as $key): extract($key); ?>
                                    <tr>
                                        <td>
                                            <div class="d-flex">
