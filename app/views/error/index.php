<body class="g-sidenav-show  bg-gray-200">
    <?php require_once DOC_ROOT.'app/views/includes/logged_navbar.php' ?>

<div class="page-header bg-gradient-dark position-relative m-3 border-radius-xl min-vh-50" style="background-image: url('<?= IMG_URL; ?>bg-pricing.jpg');">
