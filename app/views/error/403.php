        ...
        <div class="container my-auto">
            <div class="row">
                <div class="col-lg-12 m-auto text-center">
                    ...
                    <h2 class="text-white">Acesso Proibido!</h2>
                    <p class="lead text-white">Precisa Ter Sessão Iniciada para Acessar essa página.</p>
                    <a href="<?= DOC_PAGE;?>" type="button" class="btn btn-outline-white mt-4">Voltar a Página Inicial</a>
                </div>
            </div>
        </div>
    </div>
