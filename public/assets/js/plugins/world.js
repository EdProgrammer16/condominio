!function(t, e) {
    ...
    var t = {}
      ...
      , r = function() {
        function t(t) {
            return t instanceof Element ? (this.selector = t,
            this) : (this.selector = document.querySelector(t),
            this)
        }
        var e = t.prototype;
        ...
        e.css = function(t) {
            for (var e in t)
                this.selector.style[e] = t[e];
            return this
        }
        ,
        e.text = function(t) {
            return t ? (this.selector.textContent = t,
            this) : this.selector.textContent
        }
        ,
        e.attr = function(t, e) {
            return t && e ? (this.selector.setAttribute(t, e),
            this) : this.selector.getAttribute(t)
        }
        ,
        e.addClass = function(t) {
            return this.selector.classList ? (this.selector.classList.add(t),
            this) : (-1 == this.selector.className.split(" ").indexOf(t) && (this.selector.className += " " + t),
            this)
        }
        ,
        e.append = function(t) {
            return this.selector.appendChild(t),
            this
        }
        ,
        e.show = function() {
    ...
    var v = function() {
      ...
      , y = function(t) {
        ...
        return i.setStyle = function(t, e) {
            var i;
            f.isObj(t) ? f.merge(this.style.current, t) : f.merge(this.style.current, ((i = {})[t] = e,
            i));
            this.updateStyle()
        }
        ,
        i.updateStyle = function() {
            ...
            this.isSelected && (f.merge(t, this.style.selected),
    ...
    var O = function() {
        ...
        return t.prototype.render = function() {
            var t, e, i, s = this._series.scale.getTicks(), a = f.createElement("div", "jvm-legend-inner");
            ...
            for (var n = 0; n < s.length; n++) {
                switch (t = f.createElement("div", "jvm-legend-tick"),
                ...
                case "stroke":
                    ...
                    break;
                case "image":
                    e.style.background = "url(" + (f.isObj(s[n].value) ? s[n].value.url : s[n].value) + ") no-repeat center center",
      ...
      , X = function() {
        function t(t, e, i) {
            ...
            this.config.legend && (this.legend = new O(f.merge({
                map: this._map,
                series: this
            }, this.config.legend))),
    ...
    var T = Object.freeze({
        ...
        handleContainerEvents: function() {
            ...
            this.params.draggable && (this.container.on("mousemove", (function(i) {
                return s && (a.transX -= (t - i.pageX) / a.scale,
        ...
        handleElementEvents: function() {
            ...
            this.container.delegate(".jvm-element", "mouseover mouseout", (function(e) {
                ...
                "mouseover" === e.type ? e.defaultPrevented || (i.element.hover(!0),
                s && (t.tooltip.text(i.tooltipText),
                t.tooltip.show(),
                t.emit(i.event, [t.tooltip, i.code]))) : (i.element.hover(!1),
                s && t.tooltip.hide())
            }
            )),
            ...
            var t, e, i, s, a, r, n, o = this, h = function(h) {
                ...
                1 == d.length)
                    ...
                    if (2 == n)
                        ...
                        r = d[0].pageY > d[1].pageY ? d[1].pageY + (d[0].pageY - d[1].pageY) / 2 : d[0].pageY + (d[1].pageY - d[0].pageY) / 2,
                        a -= l.left,
                        r -= l.top,
                        t = o.scale,
        ...
        createTooltip: function() {
            ...
            this.container.on("mousemove", (function(i) {
                if ("block" === t.tooltip.selector.style.display) {
                    ...
                    o && (h += r + 5,
                    l -= 10),
                    i.clientX < s.left + n + 5 && (l = i.pageX + 5 + 2,
                    o && (l += 10)),
                    t.tooltip.css({
                        top: h + "px",
                        left: l + "px"
        ...
        setScale: function(t, e, i, s, a) {
            var r, n, o, h, l, c, u, p, d, f, m = this, g = 0, v = Math.abs(Math.round(60 * (t - this.scale) / Math.max(t, this.scale)));
            ...
            void 0 !== e && void 0 !== i && (r = t / this.scale,
            s ? (d = e + this.defaultWidth * (this.width / (this.defaultWidth * t)) / 2,
            f = i + this.defaultHeight * (this.height / (this.defaultHeight * t)) / 2) : (d = this.transX - (r - 1) / t * e,
        ...
        coordsToPoint: function(t, e) {
            var i, s, a, r = z.maps[this.params.map].projection, n = r.centralMeridian;
            return i = Y[r.type](t, e, n),
      ...
      , z = function() {
        function t(e) {
            ...
            "loading" !== window.document.readyState ? this.init(e.selector) : window.addEventListener("DOMContentLoaded", this.init.bind(this, e.selector))
        }
        var e = t.prototype;
        return e.init = function(t) {
            ...
            e.series && (this.container.append(this.legendHorizontal = f.createElement("div", "jvm-series-container jvm-series-h")).append(this.legendVertical = f.createElement("div", "jvm-series-container jvm-series-v")),
            this.createSeries()),
        ...
        e.reset = function() {
            ...
            this.legendHorizontal && (f.removeElement(this.legendHorizontal),
            this.legendHorizontal = null),
            this.legendVertical && (f.removeElement(this.legendVertical),
